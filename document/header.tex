...
% grafiken
\usepackage{tikz}
\usetikzlibrary{intersections,positioning, shapes.geometric}
% checkmarks
...
% keine Terennung       %
%%%%%%%%%%%%%%%%%%%%%%%%%
\hyphenation{EEROS EEDURO ROS Gazebo rviz rqt}
...
\lstloadlanguages{C,C++,xml} % entsprechende Sprachen werden hier schon mal geladen, damit das Übersetzen schneller geht
\lstset{%
  language=C,
...
\ihead{VT2: ROS Werkzeuge für EEROS-Applikationen}
\ohead{\headmark}
...
\title{VT2: ROS als unterstützendes Werkzeug für EEROS-Applikationen}
\author{Manuel Ilg}
\date{August 2017}
...
\usepackage[
  pdftitle={VT2: ROS als unterstützendes Werkzeug für EEROS-Applikationen},

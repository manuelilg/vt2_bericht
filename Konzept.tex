...
Auch kann Dank \textit{XACRO} eine XML"=Datei in mehrere Unterdateien logisch aufgeteilt werden.
%TODO vortiele einsezen in delta
Im Kapitel XX werden die Vorteile von \textit{XACRO} Anhand des Delta-Roboters 

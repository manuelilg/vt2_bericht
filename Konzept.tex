...
Und die Informationen über Position und Orientierung jedes Glieds kann \textit{RViz} den Transformations"=Daten die es laufend erhält interpretieren. %TODO ref transf
